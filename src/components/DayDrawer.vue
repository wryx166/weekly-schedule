...
<template>
  ...
  <LiveEditor v-if="day.type === DayType.NORMAL" v-model:live="day.early"
              v-model:live-type="earlyType"
              title="早场"/>
  <LiveEditor v-if="day.type === DayType.NORMAL" v-model:live="day.late"
              v-model:live-type="lateType"
              title="晚场"/>
  <LiveEditor v-if="day.type === DayType.GROUP" v-model:live="day.group"
              title="团播"/>
